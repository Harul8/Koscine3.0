"""Cache the A/B option panel for the Broken-Wing Condor strategy: same as
build_sell_panel.py but with a wider PE band (0.85 not 0.90) since the put wing here
is 8% (long put targets ~90% of spot) -- the 0.90 floor used by the symmetric-condor
panel sits right on top of that target and can miss it after nearest-strike snapping.
