"""CLI for the LOCKED Large-Move production engine.
  ...
  python -m koscine3.largemove.run walkforward   # regenerate OOS validation predictions (locks/.../predictions)
  python -m koscine3.largemove.run train         # fit production models on all data (locks/.../models)
  python -m koscine3.largemove.run predict [--date YYYY-MM-DD]  # daily ranked shortlist
"""
...
from koscine3.largemove import pipeline as P
from koscine3.largemove.config import PROD, PREDICTIONS_DIR
